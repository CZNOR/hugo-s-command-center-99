      ...
      <div className="flex-1 flex flex-col relative" style={{ zIndex: 1 }}>
        ...
        >
            ...
            {BUSINESSES.map((biz) => {
              ...
              return (
                <button
                  ...
                  onClick={() => !biz.disabled && setActiveBusiness(biz.id as BusinessId)}
          ...
          <div className="flex items-center gap-2">
            {/* XP */}
            <div className="hidden sm:flex items-center gap-1 px-2.5 py-1.5 rounded-xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)" }}>
              <Star className="w-3.5 h-3.5 text-yellow-400" />
              <span className="font-mono text-sm font-bold text-yellow-400">{g.xp_today}</span>
            ...
            <div className="hidden sm:flex items-center gap-1 px-2.5 py-1.5 rounded-xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)" }}>
              ...
              <span className="font-mono text-sm font-bold text-orange-400">{g.current_streak}</span>
            </div>
